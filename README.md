...
This repository uses Git LFS to manage large files, specifically the `.proto` files containing CAD data. **You must use Git LFS when pulling, pushing, or adjusting `.proto` files.**
