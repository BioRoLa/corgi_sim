...
I_x_coef = [-0.07858078528417953, 2.230364423829574e-16, 5.932557027624702e-16, -1.7829192366444554e-15, 1.9974073707667893e-15, -1.1598182586262335e-15, 3.3559557725640875e-16, -3.794111221038022e-17]
I_y_coef = [-0.07369365629781488, -0.043010982318856195, -0.105808860553102, 0.088854623016127, -0.031030942111082514, -0.0011104365298547842, 0.003034544443222891, -0.0004651982800853536]
J_x_coef = [-0.09344891462264798, 0.021020458601089906, 0.0023607373850017058, 0.02746299373489704, -0.02464936585742726, 0.006607585319701348, -2.770268422048543e-05, -0.00015572230063504866]
J_y_coef = [-0.06886659808323731, -0.04891744738307962, -0.05068049473849946, 0.06086518208362045, -0.03364173809733618, 0.004912621466470388, 0.0012425397194255163, -0.0002917206315845878]
...
inv_O_r_dist_coef = [0.2950074759681693, 11.973732518899368, -79.40613102657382, 1496.0933234958518, -15608.392107252332, 89915.73830862918, -272320.6046910231, 342041.314980294]
#### Polynomial ####
...
I_l_poly = np.array([ np.polynomial.Polynomial(I_x_coef), np.polynomial.Polynomial(I_y_coef)])
I_r_poly = np.array([-np.polynomial.Polynomial(I_x_coef), np.polynomial.Polynomial(I_y_coef)])
J_l_poly = np.array([ np.polynomial.Polynomial(J_x_coef), np.polynomial.Polynomial(J_y_coef)])
J_r_poly = np.array([-np.polynomial.Polynomial(J_x_coef), np.polynomial.Polynomial(J_y_coef)])
...
inv_O_r_dist_poly = np.polynomial.Polynomial(inv_O_r_dist_coef)
